package com.zhanghao.nhapp.view;
...
import com.zhanghao.nhapp.Exception.CustomException;
...
public class MyTabWidget extends LinearLayout {
    ...
    private int[] mDrawableIds = new int[] {R.drawable.bg_home,R.drawable.bg_category,R.drawable.bg_collect,R.drawable.bg_setting};
