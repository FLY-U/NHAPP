package com.zhanghao.nhapp.Kingdee;
...
public class InvokeHelper {
    ...
    static {
        ...
        map.put("login",
                "Joy.NHBusiness.ServicePlugIn.PhoneWebApi.LoginAndGetUsersInfo.login,Joy.NHBusiness.ServicePlugIn.common.kdsvc");
        map.put("changepwd",
                "Joy.NHBusiness.ServicePlugIn.PhoneWebApi.LoginAndGetUsersInfo.changePWD,Joy.NHBusiness.ServicePlugIn.common.kdsvc");
    }
    // HttpURLConnection
    ...
    public static String login(String formId, String content) throws Exception{
        return Invoke("login", formId, content);
    }
    public static String changepwd(String formId, String content)throws Exception{
        return Invoke("changepwd", formId, content);
    }
